...
public class LazyListTest {
    ...
    public void indices_Returns_all_indices_of_this_list() {
        ...
        assertEquals(Range.from(0).upToAndIncluding(5), personLazyList.indices());
        assertEquals(Range.from(0).upToAndIncluding(5), animalLazyList.indices());
        assertEquals(Range.from(0).upToAndIncluding(6), localDateLazyList.indices());
    }
    ...
    public void step_Returns_empty_list_if_this_list_is_empty() {
        assertEquals(LazyList.empty(), LazyList.empty().step(1));
    }
    ...
    public void step_Returns_a_list_containing_every_2nd_element_of_this_list() {
        assertEquals(LazyList.of(p1, p3, p5), personLazyList.step(2));
    }

    @Test
    public void step_Returns_a_list_containing_every_3rd_element_of_this_list() {
        assertEquals(LazyList.of(p1, p4), personLazyList.step(3));
    }
}